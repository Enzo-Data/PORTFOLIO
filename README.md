...
Aujourd'hui, je souhaite appliquer cette même logiques dans le domaine de l’analyse de données. Transformer des données brutes en insights utiles pour la prise de décision.
